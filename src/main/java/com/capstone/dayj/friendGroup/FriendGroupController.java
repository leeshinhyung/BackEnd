...
public class FriendGroupController {
    ...
    public void patchFriendGroup(@PathVariable int app_user_id, @PathVariable int group_id, @Valid @RequestBody FriendGroupDto.Request dto) {
        friendGroupService.updateFriendGroup(app_user_id, group_id, dto);
    }
